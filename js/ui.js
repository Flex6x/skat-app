...
const TRANSLATIONS = {
    de: {
        ...
        rules_goal_text: "Skat ist ein Strategiespiel für 3 Spieler. Der Alleinspieler spielt gegen die beiden Mitspieler (Gegner) und versucht, durch Stiche mehr als die Hälfte der Augen (mind. 61) zu gewinnen.",
        rules_players_header: "Anzahl der Spieler",
        rules_players_text: "Gespielt wird zu dritt. Es werden 32 Karten verteilt (jeder 10, plus 2 im Skat).",
        ...
        rules_values_header: "Kartenwerte",
        rules_values_text: "Die Karten haben feste Punktwerte (Augen): Ass (11), Zehn (10), König (4), Dame (3), Bube (2). 9, 8 und 7 zählen 0 Augen. Insgesamt gibt es 120 Augen.",
        rules_flow_header: "Ablauf einer Runde",
        rules_flow_text: "1. Geben: Karten werden verteilt. 2. Reizen: Wer am höchsten bietet, wird Alleinspieler. 3. Skat: Der Alleinspieler darf den Skat (2 Karten) aufnehmen und austauschen. 4. Ansagen: Trumpf wird bestimmt. 5. Spiel: 10 Stiche werden gespielt.",
        rules_bidding_header: "Reizen (einfach)",
        rules_bidding_text: "Spieler bieten Werte (z.B. 18, 20, 22). Wer den höchsten Wert bietet, darf das Spiel bestimmen. Man darf nur so hoch reizen, wie das eigene geplante Spiel wert ist.",
        rules_skat_header: "Skataufnahme",
        rules_skat_text: "Der Alleinspieler nimmt die zwei verdeckten Karten (Skat) auf und legt zwei Karten seiner Wahl wieder verdeckt ab. Die Augen der abgelegten Karten zählen am Ende für den Alleinspieler.",
        rules_trump_header: "Trumpf & Spielarten",
        rules_trump_text: "Es gibt drei Hauptarten: Farbspiel (eine Farbe + 4 Buben sind Trumpf), Grand (nur die 4 Buben sind Trumpf) und Null (kein Trumpf, Alleinspieler darf keinen Stich machen).",
        rules_winning_header: "Gewinnen & Verlieren",
        rules_winning_text: "Der Alleinspieler gewinnt, wenn er mindestens 61 Augen erreicht (beim Null-Spiel: 0 Stiche). Erreicht er dies nicht oder hat er sich überreizt, gewinnt die Gegenpartei.",
        rules_suit_header: "Farbspiel, Grand, Null",
        rules_suit_text: "Beim Farbspiel ist eine gewählte Farbe Trumpf. Beim Grand sind nur die Buben Trumpf. Beim Null-Spiel gewinnt der Alleinspieler nur, wenn er keinen einzigen Stich macht.",
        rules_hand_header: "Handspiel",
        rules_hand_text: "Verzichtet der Alleinspieler darauf, den Skat aufzunehmen, spielt er 'Hand'. Dies erhöht den Spielwert und ermöglicht weitere Ansagen wie Schneider oder Schwarz.",
        rules_schneider_header: "Schneider & Schwarz",
        rules_schneider_text: "Schneider: Eine Partei hat 30 oder weniger Augen. Schwarz: Eine Partei hat keinen einzigen Stich gemacht. Dies kann im Handspiel auch vorher angesagt werden.",
        rules_ouvert_header: "Ouvert",
        rules_ouvert_text: "Der Alleinspieler legt seine Karten offen auf den Tisch. Nur bei Handspielen möglich. Bei Null-Ouvert darf er keinen Stich machen, bei Grand-Ouvert muss er jeden Stich machen.",
        rules_spitzen_header: "Spitzen (Buben)",
        rules_spitzen_text: "Die Anzahl der lückenlosen Buben von oben (Eichel-Bube abwärts) bestimmt den Multiplikator 'mit' oder 'ohne'.",
        rules_calculation_header: "Spielwert Berechnung",
        rules_calculation_text: "Formel: (Spitzen + Bonus) * Grundwert. Grundwerte: Schellen (9), Rot (10), Grün (11), Eichel (12), Grand (24).",
        rules_ramsch_header: "Ramsch & Rollmops",
        rules_ramsch_text: "Findet sich beim Reizen kein Alleinspieler, wird oft Ramsch gespielt: Jeder spielt gegen jeden, Ziel ist es, möglichst wenig Augen zu machen. Rollmops ist eine Sonderform beim Ramsch.",
        login: "Login",
        logout: "Logout",
        profile: "Profil",
