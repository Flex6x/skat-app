...
const TRANSLATIONS = {
    de: {
        ...
        back: "Zurück",
        card_design: "Blätter",
        classic_german: "Modern",
        turnier_blatt: "Turnierblatt",
        altdeutsches_blatt: "Altdeutsches Blatt",
        store_title: "König-Store",
        ...
        badge_rot_pro: "Herz-Herzog",
        badge_rot_pro_desc: "Gewinne 15 Rot-Spiele.",
        badge_schellen_pro: "Glöckner",
    ...
    en: {
        ...
        card_design: "Decks",
        classic_german: "Modern",
        turnier_blatt: "Tournament Deck",
        altdeutsches_blatt: "Old German Deck",
        game_list: "Game List",
        total: "Total",
        ...
        badge_schellen_pro: "Bell-ringer",
...
class UI {
    ...
    _renderStatsBadgesIntoContainer(agg, container) {
        const badgeDefinitions = [
            { id: 'unbesiegbar', icon: '🛡️', title: this.getTranslation('badge_unbesiegbar'), target: 5, current: agg.schwarz_wins || 0 },
            { id: 'seriensieger', icon: '🏆', title: this.getTranslation('badge_seriensieger'), target: 5, current: agg.won_all_in_list_count || 0 },
